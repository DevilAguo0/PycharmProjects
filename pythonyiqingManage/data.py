...
def user_register(self,entry1,entry2):
...
def user_check(self,entry1,entry2):
    user_name = entry1.get()
    user_code = entry2.get()
...
def options(self):
    ...
    # tk.Button(options, text='删除疫苗信息', bg='white', font=("Arial,12"), width=20, height=2,command=self.del_vaccine_info).place(x=320, y=340)  #  TODO
...
def add(self,entry1,entry2,entry3,entry4,entry5,entry6,entry7,entry8,entry9):
    text1 = entry1.get()
    text2 = entry2.get()
    text3 = entry3.get()
    text4 = entry4.get()
...
def clear(self,entry1,entry2,entry3,entry4,entry5):
    entry1.delete(0, "end")
    entry2.delete(0, "end")
    entry3.delete(0, "end")
    entry4.delete(0, "end")
...
def add(self,entry1,entry2,entry3,entry4,entry5,entry6,entry7):
    text1 = entry1.get()
    text2 = entry2.get()
    text3 = entry3.get()
    text4 = entry4.get()
...
def clear(entry1,entry2,entry3,entry4,entry5,entry6,entry7):
    entry1.delete(0, "end")
    entry2.delete(0, "end")
    entry3.delete(0, "end")
    entry4.delete(0, "end")
...
def base_query(self,entry,text1,query):
    ID_num = entry.get()
